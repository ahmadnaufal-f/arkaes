...
rides up by the clearance it was holding for them, less its own end padding so
the travelled header stays evenly padded rather than pushing the title against
the top edge. The band goes back to the reader until scrolling stops, and both
come back together. A page whose
